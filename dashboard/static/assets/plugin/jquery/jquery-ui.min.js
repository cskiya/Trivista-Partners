...
!function(t) {
    ...
    var t, c, u, r, d, e, p, f, g, a, m, o, n, h, l, _, i, s, v, b, y, w = "ui-effects-", x = "ui-effects-style", C = "ui-effects-animated", D = k;
    function I(t, e, i) {
        var s = g[e.type] || {};
    ...
    function T(s) {
        ...
        o.length ? ("0,0,0,0" === o.join() && c.extend(o, r.transparent),
        n) : r[s]
    }
    function P(t, e, i) {
    ...
    p.fn = c.extend(p.prototype, {
        parse: function(n, t, e, i) {
            ...
            var o = this
              , s = c.type(n)
              , a = this._rgba = [];
            return t !== u && (n = [n, t, e, i],
            s = "array"),
            "string" === s ? this.parse(T(n) || r._default) : "array" === s ? (m(f.rgba.props, function(t, e) {
                a[e.idx] = I(n[e.idx], e)
            }),
    ...
    m(f, function(h, t) {
        ...
        m(o, function(a, r) {
            p.fn[a] || (p.fn[a] = function(t) {
                ...
                i = c.type(t)),
                null == t && r.empty ? this : ("string" === i && (e = d.exec(t)) && (t = o + parseFloat(e[2]) * ("+" === e[1] ? 1 : -1)),
                n[r.idx] = t,
                this[s](n)))
            }
            )
        ...
        return this.queue(function() {
            ...
            e = e.map(function() {
                ...
                this.diff = function(t, e) {
                    ...
                    for (i in e)
                        s = e[i],
                        t[i] !== s && (_[i] || !k.fx.step[i] && isNaN(parseFloat(s)) || (n[i] = s));
                    return n
                }(this.start, this.end),
                this
            }),
    ...
    k.fn.extend({
        ...
        removeClass: (n = k.fn.removeClass,
        function(t, e, i, s) {
        ...
        toggleClass: (o = k.fn.toggleClass,
        function(t, e, i, s, n) {
    ...
    k.expr && k.expr.filters && k.expr.filters.animated && (k.expr.filters.animated = (i = k.expr.filters.animated,
    function(t) {
    ...
    k.fn.extend({
        ...
        toggle: (s = k.fn.toggle,
        function(t) {
            if (H(t) || "boolean" == typeof t)
    ...
    k.fn.position = function(u) {
        ...
        k.each(["my", "at"], function() {
            ...
            1 === i.length && (i = F.test(i[0]) ? i.concat(["center"]) : R.test(i[0]) ? ["center"].concat(i) : ["center", "center"]),
        ...
        m.top += d[1],
        this.each(function() {
            var i, t, a = k(this), r = a.outerWidth(), h = a.outerHeight(), e = K(this, "marginLeft"), s = K(this, "marginTop"), n = r + e + K(this, "marginRight") + b.width, o = h + s + K(this, "marginBottom") + b.height, l = k.extend({}, m), c = q(w.my, a.outerWidth(), a.outerHeight());
            ...
            u.using && (t = function(t) {
                ...
                p < r && E(e + i) < p && (o.horizontal = "center"),
                f < h && E(s + n) < f && (o.vertical = "middle"),
                W(E(e), E(i)) > W(E(s), E(n)) ? o.important = "horizontal" : o.important = "vertical",
    ...
    k.ui.position = {
        fit: {
            left: function(t, e) {
                ...
                t.left += a - i) : t.left = !(0 < r && a <= 0) && r < a ? s + n - e.collisionWidth : s : 0 < a ? t.left += a : 0 < r ? t.left -= r : t.left = W(t.left - o, t.left)
            },
            top: function(t, e) {
                var i = e.within
                ...
                t.top += a - i) : t.top = !(0 < r && a <= 0) && r < a ? s + n - e.collisionHeight : s : 0 < a ? t.top += a : 0 < r ? t.top -= r : t.top = W(t.top - o, t.top)
            }
        },
        flip: {
            left: function(t, e) {
    ...
    var U, V, $ = 0, X = Array.prototype.slice;
    k.cleanData = (V = k.cleanData,
    function(t) {
    ...
    k.fn.button = (Q = k.fn.button,
    function() {
        return !this.length || this.length && "INPUT" !== this[0].tagName || this.length && "INPUT" === this[0].tagName && "checkbox" !== this.attr("type") && "radio" !== this.attr("type") ? Q.apply(this, arguments) : (k.ui.checkboxradio || k.error("Checkboxradio widget missing"),
    ...
    function Z() {
        ...
        this.dpDiv = tt(k("<div id='" + this._mainDivId + "' class='ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all'></div>"))
    }
    function tt(t) {
    ...
    function et() {
        k.datepicker._isDisabledDatepicker((J.inline ? J.dpDiv.parent() : J.input)[0]) || (k(this).parents(".ui-datepicker-calendar").find("a").removeClass("ui-state-hover"),
    ...
    k.extend(Z.prototype, {
        ...
        _showDatepicker: function(t) {
            ...
            !1 !== (i = (s = k.datepicker._get(n, "beforeShow")) ? s.apply(t, [t, n]) : {}) && (it(n.settings, i),
            n.lastVal = null,
    ...
    !(k.ui.ddmanager = {
        ...
        drop: function(t, e) {
            ...
            return k.each((k.ui.ddmanager.droppables[t.options.scope] || []).slice(), function() {
                this.options && (!this.options.disabled && this.visible && nt(t, this, this.options.tolerance, e) && (i = this._drop.call(this, e) || i),
        ...
        drag: function(n, o) {
            ...
            k.each(k.ui.ddmanager.droppables[n.options.scope] || [], function() {
                var t, e, i, s;
                this.options.disabled || this.greedyChild || !this.visible || (s = !(i = nt(n, this, this.options.tolerance, o)) && this.isover ? "isout" : i && !this.isover ? "isover" : null) && (this.options.greedy && (e = this.options.scope,
